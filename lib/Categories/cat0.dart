...
class _Cat0State extends State<Cat0> {
  List<MenuItem> menuItems = [
    MenuItem(
        ...
        size: "500ml",
        price: 550,
        imagePath: 'assets/images/chutni/greenChatni.jpg',
        soldStatus: false,
        qtySold: 1,
        productNo: 001),
    MenuItem(
        ...
        size: "200 ml",
        price: 340,
        imagePath: 'assets/images/chutni/redChatni.jpg',
        soldStatus: false,
        qtySold: 1,
        productNo: 002),
    MenuItem(
        ...
        size: "700ml",
        price: 500,
        imagePath: 'assets/images/chutni/YellowChatni.jpg',
        soldStatus: false,
        qtySold: 1,
        productNo: 003),
    MenuItem(
        ...
        size: "500ml",
        price: 250,
        imagePath: 'assets/images/chutni/imli.jpg',
        soldStatus: false,
        qtySold: 1,
        productNo: 004),
    MenuItem(
        title: "Khubani Chatni",
        category: "Chatnis",
        size: "700ml",
        price: 500,
        imagePath: 'assets/images/chutni/khubani.jpg',
        soldStatus: false,
        qtySold: 1,
        productNo: 004),
    MenuItem(
        title: "Cranberry Chatni",
        category: "Chatnis",
        size: "700ml",
        price: 500,
        imagePath: 'assets/images/chutni/cranberry.jpg',
        soldStatus: false,
        qtySold: 1,
        productNo: 005),
    MenuItem(
        ...
        size: "700ml",
        price: 500,
        imagePath: 'assets/images/chutni/mango.jpg',
        soldStatus: false,
        qtySold: 1,
        productNo: 006),
  ];
