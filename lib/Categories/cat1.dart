...
class Cat1 extends StatefulWidget {
  ...
  @override
  State<Cat1> createState() => _Cat0State();
}

class _Cat0State extends State<Cat1> {
  List<MenuItem> menuItems = [
    MenuItem(
        ...
        size: "700ml",
        price: 650,
        imagePath: 'assets/images/sauces/BlackBeanSauce.jpg',
        soldStatus: false,
        qtySold: 1,
        productNo: 007),
    MenuItem(
        ...
        size: "500 ml",
        price: 340,
        imagePath: 'assets/images/sauces/HotPepperSauce.jpg',
        soldStatus: false,
        qtySold: 1,
        productNo: 008),
    MenuItem(
        ...
        size: "700ml",
        price: 500,
        imagePath: 'assets/images/sauces/ketoSauce.jpg',
        soldStatus: false,
        qtySold: 1,
        productNo: 009),
    MenuItem(
        ...
        size: "500ml",
        price: 250,
        imagePath: 'assets/images/sauces/mirchisauce.jpg',
        soldStatus: false,
        qtySold: 1,
        productNo: 010),
    MenuItem(
        ...
        size: "700ml",
        price: 500,
        imagePath: 'assets/images/sauces/Peanutsauce.jpg',
        soldStatus: false,
        qtySold: 1,
        productNo: 011),
    MenuItem(
        ...
        size: "700ml",
        price: 500,
        imagePath: 'assets/images/sauces/Tomatosauce.jpg',
        soldStatus: false,
        qtySold: 1,
        productNo: 012),
  ];
